...
done < tmp/bpa-plants_Atherospermataceae_20210316T0451_urls.txt

echo "Data download complete. Verifying checksums:"
md5sum -c tmp/bpa-plants_Atherospermataceae_20210316T0451_md5sum.txt 2>&1 | tee tmp/md5sum.log